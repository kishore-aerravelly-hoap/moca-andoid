...
/**
 * The Class TeacherExamUI.
 */
public class TeacherExamUI {

    /** The teacher exam ui. */
    private static TeacherExamUI teacherExamUI = null;
    ...
    /**
     * Instantiates a new teacher exam ui.
     */
    private TeacherExamUI() {
    }

    /**
     * Gets the single instance of TeacherExamUI.
     *
     * @return single instance of TeacherExamUI
     */
    public static TeacherExamUI getInstance() {
	if (teacherExamUI == null) {
	    teacherExamUI = new TeacherExamUI();
	}

	return teacherExamUI;
    }
	...
	sv.addView(teacherAnswer);
	layout.addView(sv, answerParams);
	...
	final LinearLayout.LayoutParams defaultParams = new LinearLayout.LayoutParams(
		android.view.ViewGroup.LayoutParams.FILL_PARENT,
		android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
	defaultParams.setMargins(40, 5, 30, 5);
	
	final RadioGroup.LayoutParams radioParams = new RadioGroup.LayoutParams(
			android.view.ViewGroup.LayoutParams.FILL_PARENT,
			android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
	radioParams.setMargins(36, 5, 30, 5);

	final LinearLayout.LayoutParams answerParams = new LinearLayout.LayoutParams(
		android.view.ViewGroup.LayoutParams.FILL_PARENT,
		android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
	answerParams.setMargins(36, 5, 30, 5);
	...
	final LinearLayout.LayoutParams answerParams= new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT,
			android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
	...
	if(scrnsize > 8){
		...
		answerParams.setMargins(35, 2, 30, 2);
	}else{
		answerParams.setMargins(25, 2, 15, 2);
	}
	...
	if (ordQuestion != null) {
	    ...
	    orderingQuestionList.setLayoutParams(answerParams);
	    orderingQuestionList.setCacheColorHint(Color.parseColor("#E9E9E9"));
	    /*ScrollView sv = new ScrollView(activity);
	    sv.addView(orderingQuestionList);*/
	...
	final LinearLayout.LayoutParams answerParams =  new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.FILL_PARENT,
			android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
	answerParams.setMargins(25, 2, 30, 2);
	...
	if (multipleChoiceQuestion != null) {
	   ...
	   /* ScrollView sv = new ScrollView(activity);
	    sv.addView(matchTheFollowingList);*/
	...
	public View getView(final int position, View view, ViewGroup parent) {
	    ...
	    question.setLayoutParams(new android.widget.LinearLayout.LayoutParams(370, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
	    answerChoice.setLayoutParams(new  android.widget.LinearLayout.LayoutParams(350, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
