...
public class Exam implements Serializable {
    ...
    /** The exam created teacher name. */
    private String examCreatedTeacherName;

    /**
     * Gets the exam created teacher name.
     *
     * @return the exam created teacher name
     */
    public String getExamCreatedTeacherName() {
	return examCreatedTeacherName;
    }

    /**
     * Sets the exam created teacher name.
     *
     * @param examCreatedTeacherName the new exam created teacher name
     */
    public void setExamCreatedTeacherName(String examCreatedTeacherName) {
	this.examCreatedTeacherName = examCreatedTeacherName;
    }

    /**
     * Gets the open books.
     *
     * @return the open books
     */
     ...
     * Sets the open books.
     *
     * @param openBooks the new open books
     */
	...
	return "Exam [id=" + id + ", examDetails=" + examDetails
		...
		+ ", examCreatedTeacherName=" + examCreatedTeacherName + "]";
    }
	...
	xml += "		<description>" + this.getExamDetails().getDescription()
		+ "</description>";
	xml += "		<starttime>" + this.getExamDetails().getStartTime()
		+ "</starttime>";
	xml += "		<endtime>" + this.getExamDetails().getEndTime()
		+ "</endtime>";
	...
	final int size = getNumberOfQuestions();
	if (size != 0 && questionNo <= getNumberOfQuestions()) {
     ...
     *
     * @return the examCreatedTeacherId
     */
