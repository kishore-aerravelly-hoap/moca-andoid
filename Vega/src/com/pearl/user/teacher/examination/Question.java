...
public class Question implements Serializable {
    ...
    /** The book name. */
    protected String bookName="";//Added chapterName for feature reference to fetch existing questions while preparing questionPaper.
    ...
    /** The marks awarded. */
    protected double marksAwarded = 0.0;
    ...
    /** The question_update. */
    protected boolean question_update=false;
     ...
     * HELPER FUNCTIONS.
     *
     * @return true, if is question_update
     */
    /*
	public boolean isCorrectAnswer()
			throws ManualCorrectionTypeQuestionException {
		if (!isManualCorrection) {
			...
			throw new ManualCorrectionTypeQuestionException();
		}
	}*/

    public synchronized boolean isQuestion_update() {
  		return question_update;
  	}

  	/**
	   * Sets the question_update.
	   *
	   * @param question_update the new question_update
	   */
	  public synchronized void setQuestion_update(boolean question_update) {
	...
	return "Question [id=" + id + ", questionOrderNo=" + questionOrderNo
		+ ", question=" + question + ", description=" + description
		+ ", durationInSecs=" + durationInSecs + ", hint=" + hint
		+ ", type=" + type + ", difficultyLevel=" + difficultyLevel
		+ ", chapterName=" + chapterName + ", bookName=" + bookName
		+ ", marksAllotedByTeacher=" + marksAllotedByTeacher
		+ ", correctAnswer=" + correctAnswer + ", marksAlloted="
		+ marksAlloted + ", isCorrected=" + isCorrected
		+ ", studentAnswer=" + studentAnswer + ", marksAwarded="
		+ marksAwarded + ", isAnswered=" + isAnswered + ", isViewed="
		+ isViewed + ", isMarked=" + isMarked + ", existed=" + existed
		+ ", isCorrect=" + isCorrect + "]";
    }
