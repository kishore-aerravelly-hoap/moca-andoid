...
/**
 * The Class CrossFadeDrawable.
 */
public class CrossFadeDrawable extends Drawable {
    
    /** The Constant TRANSITION_STARTING. */
    private static final int TRANSITION_STARTING = 0;
    
    /** The Constant TRANSITION_RUNNING. */
    private static final int TRANSITION_RUNNING = 1;
    
    /** The Constant TRANSITION_NONE. */
    private static final int TRANSITION_NONE = 2;

    /** The m transition state. */
    ...
    /**
     * Instantiates a new cross fade drawable.
     *
	...
	mReverse = false;
	mTransitionState = mStart != mEnd ? TRANSITION_STARTING
		: TRANSITION_NONE;
	invalidateSelf();
    }
	...
	case TRANSITION_RUNNING:
		...
		final float normalized = (float) (SystemClock.uptimeMillis() - mStartTimeMillis)
			/ mDuration;

		done = normalized >= 1.0f;
		mAlpha = (int) (mFrom + (mTo - mFrom)
    ...
    /* (non-Javadoc)
     * @see android.graphics.drawable.Drawable#setFilterBitmap(boolean)
     */
    @Override
